...
function WidgetCard({ widget }: { widget: Widget }) {
    ...
    return (
        <div className="group flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
            {/* Header */}
            ...
            <div className="flex items-center gap-2 border-t border-gray-100 pt-1">
                <a
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 shadow-sm transition-colors hover:border-brand-300 hover:text-brand-600"
                >
                ...
                {widget.installation.iframe_url && (
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 rounded-lg border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-medium text-brand-600 shadow-sm transition-colors hover:bg-brand-100"
                    >
