        ...
        >
            <div className="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">Передайте клиенту эту страницу или откройте ее вместе с ним.</p>
                </div>
                <a className="text-sm text-blue-700" href={links.oauth}>Все OAuth-подключения</a>
            </div>
            ...
            <div className="grid gap-4 lg:grid-cols-3">
                <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm lg:col-span-2">
                    ...
                    <dl className="grid gap-3 text-sm">
                        ...
                        <div>
                            <dt className="text-slate-500">Secrets URI</dt>
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <dl className="space-y-3 text-sm">
                        <div>
                            <dt className="text-slate-500">Текущий статус</dt>
                        ...
                        {connection.account ? (
                            <div>
                                <dt className="text-slate-500">Аккаунт в сервисе</dt>
                                <dd><a className="text-blue-700" href={connection.account.url}>{connection.account.name}</a></dd>
                            </div>
                        ) : null}
                        {connection.error_message ? (
                            <div>
                                <dt className="text-slate-500">Ошибка</dt>
