...
export default function TaskOverdueDashboardV2Dev({ account, period, links }: Props) {
                        ...
                        <div className="flex min-w-0 items-center gap-5">
                            ...
                            <div className="min-w-0">
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <div className="inline-flex items-center rounded-full bg-amber-500/20 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-300 ring-1 ring-amber-400/40">
                                        DEV — тестовая версия
                                    </div>
                                </div>
