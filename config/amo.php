...
return [
    ...
    'external' => [
        'name' => env('AMO_EXTERNAL_INTEGRATION_NAME', 'Sonic Expert'),
        'description' => env('AMO_EXTERNAL_INTEGRATION_DESCRIPTION', 'Интеграция Sonic Expert для подключения amoCRM.'),
